...
const { toast } = useToast()
  ...
  return (
    <div className='min-h-screen w-full flex flex-col justify-between items-center'>
      ...
      {mostrar ?
        <Dogform id={id}></Dogform> :
        <div className='flex flex-col w-3/4 justify-around h-full '>
          <h1 className='text-3xl font-bold mb-12 mt-6 text-[#004e89]'>Ingresá la clave que vino con tu QR para poder editar los datos de tu mascota</h1>
